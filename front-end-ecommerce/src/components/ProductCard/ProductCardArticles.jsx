...
import ComboPolloCrispyCard from '../../assets/images/ComboPolloCrispyCard.png';

// Define el componente Home que contiene una lista de ProductCards
function ProductCardArticles() {
    return (
...
export default ProductCardArticles; // Exporta el componente Home para que pueda ser usado en otras partes del proyecto
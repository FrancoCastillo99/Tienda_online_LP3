...
import menuIcon from '../assets/icons/navBarIcon/menu-icon.png';
import cancelIcon from '../assets/icons/navBarIcon/cancel-icon.png';
import ShopIcon from '../assets/icons/navBarIcon/shop-icon.png';
import searchIcon from '../assets/icons/navBarIcon/search-icon.png';
import './NavBar.css';
            ...
            <nav className="navbar">
                <div className="navbar-content">
                    <div className="navbar-section left">
                        <Link to="client/home" className="home-text" onClick={handleHomeClick}>HOME</Link>
                    </div>
            ...
            {isMenuOpen && (
                <div className="menu-overlay" style={{ top: `${navbarHeight}px` }}>
                    <div className="menu-modal">
                        ...
                        <ul>
                        <li><Link to="/client/profile" onClick={handleNavigation}>PERFIL</Link></li>
